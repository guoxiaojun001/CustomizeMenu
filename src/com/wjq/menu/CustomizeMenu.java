	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		menuGrid.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				switch (arg2) {
				case ITEM_SEARCH://  搜索
					Toast.makeText(CustomizeMenu.this, "搜索菜单被点击了", Toast.LENGTH_LONG).show();

					break;
				case ITEM_FILE_MANAGER:// 文件管理
					Toast.makeText(CustomizeMenu.this, "文件菜单被点击了", Toast.LENGTH_LONG).show();
					break;
				case ITEM_DOWN_MANAGER:// 下载管理
					Toast.makeText(CustomizeMenu.this, "下载菜单被点击了", Toast.LENGTH_LONG).show();
					break;
